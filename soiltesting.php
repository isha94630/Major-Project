...
<head>
    ...
    <link rel="stylesheet" href="styleSoilTesting.css">
...
<body>
    <div class="contact-container">
        <form action="https://api.web3forms.com/submit" method="POST" class="contact-left">
            ...
            <p><a href="services.php"><B><u>Back to Services<i class="fa-solid fa-hand-point-left"></i></B></u></a></p>
        </form>
        <div class="contact-right">
            <img src="img/SoilTesting1.jpg" alt="">
        </div>
    </div>
</body>
</html>